...
//   // for gps conversion keyboard

//   // AppTheme additions

//   // Colors for the keypad surface and keys (works in light/dark)
//   static const Color keypadSurfaceLight = Color(0xFFF3F4F6); // subtle bg block
//   static const Color keypadKeyBg = Color(0xFFE5E7EB); // key cap
//   static const Color keypadKeyText = Colors.black87;
//   static const Color keypadAccentRed = Color(0xFFE35D4A); // NESW
//   static const Color keypadAccentGold = Color(0xFFF2C94C); // symbols
...
// // Surface behind the keypad (semi-opaque so the watermark doesn’t fight it)
// static Color keypadSurface(BuildContext ctx) =>
//     Theme.of(ctx).brightness == Brightness.dark
...
// // Button style used by GpsKeypad
// static ButtonStyle gpsKeyButtonStyle({Color? background}) =>
//     ElevatedButton.styleFrom(
//       backgroundColor: background ?? Colors.grey.shade300,
//       foregroundColor: Colors.black87,
//       padding: EdgeInsets.zero,
