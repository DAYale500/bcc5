  ...
  routes: [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) {
        ...
        final bnbLessonsKey = GlobalKey(debugLabel: 'BNBLessonsKey'); // ✅
        final bnbPartsKey = GlobalKey(debugLabel: 'BNBPartsKey'); // ✅
        final bnbToolsKey = GlobalKey(debugLabel: 'BNBToolsKey'); // ✅
        final bnbFlashcardsKey = GlobalKey(debugLabel: 'BNBFlashcardsKey'); // ✅
        logger.i(
          '📘 [GoRouter] Building LandingScreen with onboarding keys',
        ); // ✅
        ...
        return TransitionManager.buildCustomTransition(
          ...
          child: MainScaffold(
            ...
            bnbPartsKey: bnbPartsKey, // ✅
            bnbToolsKey: bnbToolsKey, // ✅
            bnbFlashcardsKey: bnbFlashcardsKey, // ✅
            child: LandingScreen(
